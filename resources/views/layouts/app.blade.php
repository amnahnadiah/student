...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('templates/app-assets/css/pages/page-auth.css') }}">
    <!-- END: Page CSS-->
...
<body class="vertical-layout vertical-menu-modern blank-page navbar-floating footer-static  " data-open="click" data-menu="vertical-menu-modern" data-col="blank-page">
                ...
                <div class="auth-wrapper auth-v2">
                    <div class="auth-inner row m-0">
                        <!-- Brand logo--><a class="brand-logo" href="javascript:void(0);">
                            ...
                            <h2 class="brand-text text-primary ml-1">Tuition</h2>
                        </a>
                        <!-- /Brand logo-->
                        <!-- Left Text-->
                        <div class="d-none d-lg-flex col-lg-8 align-items-center p-5">
                            <div class="w-100 d-lg-flex align-items-center justify-content-center px-5"><img class="img-fluid" src="{{ asset('templates/app-assets/images/avatars/home.svg') }}" alt="Login V2" /></div>
                        </div>
                        <!-- /Left Text-->
                        @yield('content')
                    </div>
    ...
    <!-- BEGIN: Page JS-->
    <script src="{{ asset('templates/app-assets/js/scripts/pages/page-auth-login.js') }}"></script>
    <!-- END: Page JS-->
