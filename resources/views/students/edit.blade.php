         ...
         <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <strong>Grade:</strong>
                    <input type="text" name="grade" value="{{ $student->grade }}" class=form-control placeholder="Grade">
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <strong>Delete ID:</strong>
                    <input type="int" name="deleteId" value="{{ $student->deleteId }}" class=form-control placeholder="Delete ID">
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
