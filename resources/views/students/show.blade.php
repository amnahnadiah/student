                                                ...
                                                <div class="d-flex justify-content-start">
                                                    <div class="d-flex flex-column ml-1">
                                                        ...
                                                        <div class="demo-inline-spacing">
                                                            <a href="{{ Request::root() }}/student-edit/{{ $student->id }}" class="btn btn-outline-info round">Edit</a>
                                                            <form action="{{ url('student-destroy/' .$student->id) }}" method="POST">
                                                               {{ method_field('DELETE') }} 
                                                               {{ csrf_field() }} 
                                                            <button type="submit" class="btn btn-outline-danger round">Delete</button>
                                                            </form>
                                                        </div>
                                                    </div>
                                                </div>
